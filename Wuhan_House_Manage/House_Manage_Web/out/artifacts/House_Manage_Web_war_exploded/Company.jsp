...
<div id="container" style="width:-moz-max-content">
    ...
    <div id="content" style="background-color:#EEEEEE;height: auto;width:880px;float:left;">
        <table border="1" style="font-style: normal;font-size: small">
            <tr>
                ...
                <a href="AddOrAlterNeigh.jsp" style="color: green;float: right;margin-left: 10px">添加小区</a>
                <a href="AddOrAlterHouse.jsp" style="color: green;float: right;margin-left: 10px">添加房源</a>
            ...
            <c:forEach items="${result.rs}" var="house">
                <tr>
                    ...
                    <td>${house.towards}</td>
                    <td>
                        <a href="HomepageServlet?type=neigh&nname=${house.nname}" style="color: green;margin-right: 10px">${house.nname}</a>
                        <a href="HomepageServlet?type=altern&nname=${house.nname}" style="color: #2175BC;margin-right: 10px">修改小区</a>
                        <a href="HomepageServlet?type=deleten&nname=${house.nname}" style="color: red">删除小区</a>
                    </td>
                    <td>${house.hfloor}</td>
                    <td>${house.tfloor}</td>
